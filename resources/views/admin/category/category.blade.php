        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">لیست طبقات </h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <table class="table table-striped" id="table-data1">
                        ...
                        @foreach($category as $k =>$val)
                            <tr>
                                ...
                                <td> {{$val->name}}</td>
                                <td>
                                    <a href="{{route('category.sub')}}?id={{$val->id}}" style="color: #7330d2;text-decoration: none">
                                        <i class="fa fa-filter"></i>
                                    </a>
                                    <a href="{{route('category.edit',$val->id."&2")}}" style="color: orange;text-decoration: none">
